...
def main():
  ...
  distance_euclidian = euclidian_distance_improve(len(asset), distance)
  distance_euclidian_square = squareform(distance_euclidian)
  ...
  #rec_bisection = recursive_bisection(data_stocks.cov(), sortIx)
  #print(rec_bisection)
